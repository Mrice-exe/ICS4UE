...
class EasterVariation2 {
    public static void EasterVariation2(String[] args) {
        ...
        int q = floor(8 * (a + 11) /25) % 25; //quotient of 8*(a+11) divided by 25
        int f = (5*a+b) %19; // remainder of 5a+b divided by 19
        int g = (19f + c -q)%30; //remainder of 19f + c -q divided by 30
        int h = floor((f+11*g)/319); //quotient of f + 11g divided by 319
        int j = floor((60 * (5 - d) + b) / 4); //quotient of 60 * (5 - d) + b divided by 4
        int k = (60 * (5 - d) + b) %4; //remainder of 60 * (5 - d) + b divided by 4
        int n = (2*j - k - g + h) %7; // remainder of 2j - k - g + h divided by 7
        int month = floor((g - h + n + 114)/31); // the month is the quotient of g - h + n + 114 divided by 31
